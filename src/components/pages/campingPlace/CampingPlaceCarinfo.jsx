              ...
              <Link to={`/camping-place/${value.id}`}>
                <CampingPlaceItem $small key={value.id}>
                  <MotorItemImg $campingPlace>
                    <CampingImgs $small src={value.campingPlace.photo} />
            ...
            return (
              <CampingPlaceCarinfoContainer $campingPlace>
                <ItemReviewItems $campingPlace>
                  <CarinfoInfoName>{value.campingPlace.name}</CarinfoInfoName>
                  <MotorsLeftCheckInputContainer $campingPlace>
                    <BlueText $bigText>{value.campingPlace.location}</BlueText>
                ...
                <CampingInformationContainer>
                  ...
                  <CampinInformation>
                    ...
                    <div>
                      from {value.campingPlace.working_hour.from} to{" "}
                      {value.campingPlace.working_hour.to}
                    </div>
                  </CampinInformation>

                  <CampinInformation $informationLeft>
                    <Imgwrapper src={phone} />
                    <div>{value.campingPlace.phone_number}</div>
                  </CampinInformation>

                  <CampinInformation>
                    <Imgwrapper src={home} />
                    <BlueText>{value.campingPlace.home_page}</BlueText>
                  </CampinInformation>
                </CampingInformationContainer>

                <div>
                  <BlueText $description $bigText>Description</BlueText>
