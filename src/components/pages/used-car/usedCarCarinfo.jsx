        ...
        <CarinfoBoxContainer>
          <CarinfoItems>
            ...
            <CarinfoItemTextContainer $leftText>
              ...
              <CarinfoItemText>
                ...
                pulvinar. <br /> Eget amet dictum luctus quis molestie tellus
                vitae.Lorem ipsum <br /> dolor sit amet, consectetur adipiscing
                elit. Rutrum nibh urna <br /> sagittis arcu natoque lectus
                cursus felis. Nec, felis risus, id in proin <br /> sed proin
                iaculis mi.
              </CarinfoItemText>
            </CarinfoItemTextContainer>
          ...
          <CarinfoItems>
            ...
            <CarinfoItemTextContainer $leftText>
              ...
              <CarinfoItemText>
                ...
                <br /> guarantee of energy efficiency and durability. <br /> As
                for ventilation, we also often offer double ventilation in the{" "}
                <br />
                bathroom (Skylight + window), which is very popular with our{" "}
                <br /> customers… Camper relies on legendary Seitz windows. They
                offer the best <br />
                insulation and are also the easiest to use and safest because
                they <br /> can’t be removed from the outside.
              </CarinfoItemText>
            </CarinfoItemTextContainer>
          ...
          <CarinfoItems>
            ...
            <CarinfoItemTextContainer $leftText>
              ...
              <CarinfoItemText>
                ...
                <br /> All our motorhomes are equipped with a built-in step to
                facilitate <br /> entry to the vehicle <br /> All our vans are
                equipped with an electric step.
              </CarinfoItemText>
            </CarinfoItemTextContainer>
          </CarinfoItems>
          ...
          <CarinfoItems>
            ...
            <CarinfoItemTextContainer $leftText>
              ...
              <CarinfoItemText>
                Fuel heating is now very popular in the industry, but this was
                not <br /> always the case; Camper (once again) led the way in
                this area over <br /> 15 years ago. <br /> One of the advantages
                it offers is that it can heat up your vehicle <br /> while you
                drive, for a more comfortable arrival.
              </CarinfoItemText>
              <CarinfoItemText>
                <CarinfoButtons>
